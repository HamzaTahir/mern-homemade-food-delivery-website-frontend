...
import {signup, authenticate, facebooksignup, googlesignup} from '../admin/auth/index';
    ...
    if(loading1 === true){
        ...
        return(
            <div>
                <Menu/>
            {/* <Layout/> */}
                <div className="container-fluid col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 mb-2" style={{
                    }}> 
                    <p style={{fontSize:27, fontWeight:600, textAlign:"center", margin:0, padding:0}}>Welcome!</p>
                    <p style={{fontSize:23, fontWeight:500, textAlign:"center", margin:0, padding:0}}>Admin SignUp</p>
                        {/* {showError()} */}
                        {/* {showSuccess()} */}
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-4">
                                ...
                                <div className="row">
                                    <div className="col-12" style={{textAlign:'right'}}>
                                        <Link to="/admin/signin" style={{color:'#007bff'}}>Have a Account? Login here</Link>
                                    </div>
                                </div>
                                <br/>
