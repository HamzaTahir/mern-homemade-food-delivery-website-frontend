...
const Signin = () =>{
    ...
    return(
        <Layout title="Foodlancer Signin" description="Node React E-Commerce App Signin" className="container col-md-8 offset-md-2">
            <div className="container col-md-8" style={{
            //   position: 'absolute', left: '50%', top: '50%',
            //   transform: 'translate(-50%, -50%)'
            }}> 
            <p style={{fontSize:27, fontWeight:600, textAlign:"center"}}>KHANSAMA Foodlancer Sign In</p>
              {showLoading()}
              {showError()}
              {signinForm()}
            </div>
